...
Yeoh2002, the gradient strategy needs about 4 times as many passes as Newton to
bring the relative suboptimality bound below $10^{-4}$. On Shuttle, whose rarest
...
(@fig-cold-start-poisson). The objective values after the first pass show this
temporary excursion: the unguarded runs sit between $+2 \times 10^6$ and
$+5 \times 10^6$ across the five seeds, whereas the guarded ones are already
near $-2 \times 10^5$.
