...
- Using a Schur-complement analysis, we show that the mismatch between local
  intercept curvature $H_{00}$ and the global bound $L_0$ explains the gradient
  strategy's slowdown. In strongly coupled problems, the predicted
  gradient-to-Newton rate ratio approaches $L_0/H_{00}$.
