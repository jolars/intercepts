...
$$
  F(\beta_0, \beta)
  = \frac{1}{n}\sum_{i=1}^n f(x_i^\top \beta + \beta_0; y_i).
$$
...
$H_{00} = U\operatorname{diag}(\lambda_r)U^\top$. The gradient strategy
...
$\lVert X^\top \Theta \rVert_\infty \le \lambda$. Within each problem, we
...
$\lVert X^\top \Theta \rVert_\infty \le \lambda$; this second step
