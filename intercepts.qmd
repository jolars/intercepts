...
disappears. Yet, adelie\ [@yang2024] provides a solution for this: at each
linearization, its proximal quasi-Newton method builds a weighted Gaussian
surrogate and absorbs the intercept implicitly through that surrogate rather
than as a separate CD coordinate.^[Source:
