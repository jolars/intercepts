...
draw(spec_grad * visual(Heatmap), figure = (; size = (380, 230)))
```
...
draw(spec_sk * visual(Heatmap), figure = (; size = (380, 230)))
```
...
draw(visual(Lines) * spec, axis = (yscale = log10,), figure = (; size = (420, 260)))
```
...
draw(visual(Lines) * spec, axis = (; yscale = log10), figure = (; size = (500, 240)))
```
